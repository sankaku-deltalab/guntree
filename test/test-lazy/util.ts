...
export const createRepeatStateManagerWithGet = (getFunc: jest.Mock): IRepeatStateManager => {
    const rsm = simpleMock<IRepeatStateManager>();
    rsm.get = getFunc;
    return rsm;
};

export const createFiringStateWithRSM = (rsm: IRepeatStateManager): IFiringState => {
